...
if TYPE_CHECKING:
    from fll_scheduler_ga.domain.model import EventRepository, Schedule


def test_schedule_operations(empty_schedule: Schedule, evt_repo: EventRepository) -> None:
...
def test_schedule_clone_and_hash(empty_schedule: Schedule, evt_repo: EventRepository) -> None:
