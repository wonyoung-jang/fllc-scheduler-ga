...
def test_time_format_inference_error(minimal_config_dict: dict, tmp_path: Path) -> None:
    ...
    minimal_config_dict["rounds"][0]["start_time"] = "09:00 AM"  # 12H
    minimal_config_dict["rounds"][0]["stop_time"] = "09:30"  # 24H

    config_file = tmp_path / "bad_config.json"
    with config_file.open("w") as f:
        json.dump(minimal_config_dict, f)

    with pytest.raises(ValueError, match="Conflicting time formats"):
